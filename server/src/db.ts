...
export const products: Product[] = [
    ...
    { id: '3', name: 'Mechanical Keyboard', price: 129, description: 'Tactile feedback for the ultimate typing experience.', image: 'https://images.unsplash.com/photo-1595225476474-87563907a212?w=500&auto=format&fit=crop&q=80', category: 'Electronics' },
    ...
    // Home Decor
    { id: '22', name: 'Decorative Wall Art', price: 59, description: 'Abstract art to brighten any room.', image: 'https://images.unsplash.com/photo-1541963463532-d68292c34b19?w=500&auto=format&fit=crop&q=80', category: 'Home Decor' },
    ...
    { id: '30', name: 'Wireless Charger', price: 29, description: 'Fast charging for smartphones.', image: 'https://images.unsplash.com/photo-1615526675159-e248c3021d3f?w=500&auto=format&fit=crop&q=80', category: 'Electronics' },
    ...
    { id: '32', name: 'Smart Home Hub', price: 199, description: 'Control all smart devices from one place.', image: 'https://images.unsplash.com/photo-1563461660947-507ef49e9c47?w=500&auto=format&fit=crop&q=80', category: 'Electronics' },
    ...
    { id: '35', name: 'Decorative Candles', price: 30, description: 'Scented candles for ambiance.', image: 'https://images.unsplash.com/photo-1603006905003-be475563bc59?w=500&auto=format&fit=crop&q=80', category: 'Home Decor' },
    // Food
